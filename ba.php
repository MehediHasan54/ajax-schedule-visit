<select id="dropdownTimeZone" name="dropdowntimezone">
   <option value="nothing">Select Timezone</option>
   ...
   <option value="Asia/Ulan_Bator">Asia/Ulan_Bator (GMT+08:00)</option>
   ...
   <option value="Pacific/Funafuti">Pacific/Funafuti (FGMT+12:00)</option>
